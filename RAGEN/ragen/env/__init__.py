...
from .underspecified_bandit.env import UnderspecifiedBanditEnv
from .underspecified_bandit.config import UnderspecifiedBanditEnvConfig
from .lbat.env import LBATEnv
from .lbat.config import LBATEnvConfig
...
REGISTERED_ENVS = {
    ...
    'underspecified_bandit': UnderspecifiedBanditEnv,
    'lbat': LBATEnv,
}
...
REGISTERED_ENV_CONFIGS = {
    ...
    'underspecified_bandit': UnderspecifiedBanditEnvConfig,
    'lbat': LBATEnvConfig,
}
