...
@hydra.main(
    ...
    config_name="generate_guess_my_city_difficulty",
)
def main(config: DictConfig):
    """
    Main entry point for estimating difficulty level for guess my city
    ...
    for i in range(len(game_scenarios)):
        ...
        system_prompt = (
            "You are an expert judge of the game 'Guess My City'. "
            "In this game, the player needs to guess the name of target city "
            "by only asking 20 questions about the city's geographics, culture, weather, etc."
            "I will give you a city, and you must classify it into easy, medium or hard, "
            "based on an estimate of how easy it is to guess this city, "
            "and an estimate of how many turns it will take to guess the city. "
        ...
        user_message = f"Your city is: {topic}"
